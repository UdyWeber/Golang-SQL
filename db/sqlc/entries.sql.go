...
func (q *Queries) GetAllEntries(ctx context.Context, arg GetAllEntriesParams) ([]Entry, error) {
	rows, err := q.db.Query(ctx, getAllEntries, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetEntriesByAccount(ctx context.Context, accountID int64) ([]Entry, error) {
...
func (q *Queries) UpdateEntry(ctx context.Context, arg UpdateEntryParams) (Entry, error) {
	row := q.db.QueryRow(ctx, updateEntry, arg.Amount, arg.AccountID, arg.ID)
	var i Entry
	err := row.Scan(
		&i.ID,
		&i.AccountID,
